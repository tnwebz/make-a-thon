...
TECHNICAL_GLOSSARY: Dict[str, str] = {
    # Keep unchanged in Hindi context or provide natural transliteration
    "Java": "Java",
    "Python": "Python",
...
class GlossaryProtector:
    ...
    def restore_text(self, translated_text: str, placeholder_map: Dict[str, str]) -> str:
        ...
        for placeholder, original in placeholder_map.items():
            # Match placeholder allowing for occasional space insertions by tokenizer
